...
typestate SPMCPushContext[T, S: static int, MT: static int]:
  ...
  states SPMCPushReady[T, S, MT],
    SPMCPushSegmentLoaded[T, S, MT],
    SPMCPushSegmentFull[T, S, MT],
    SPMCPushSlotReady[T, S, MT],
    SPMCPushComplete[T, S, MT]
  transitions:
    SPMCPushReady[T, S, MT] -> SPMCPushSegmentLoaded[T, S, MT]
    SPMCPushSegmentLoaded[T, S, MT] ->
      (SPMCPushSlotReady[T, S, MT] | SPMCPushSegmentFull[T, S, MT]) as
      SPMCSegmentCheck[T, S, MT]
...
proc startPush*[T; S, MT: static int](
    pinned: sink Pinned[MT], queue: ptr UnboundedSipmuc[S, T, MT]
...
proc allocateNewSegment*[T; S, MT: static int](
    full: sink SPMCPushSegmentFull[T, S, MT], newSegment: ptr Segment[S, T]
...
proc writeItem*[T; S, MT: static int](
    slotReady: sink SPMCPushSlotReady[T, S, MT], item: T
