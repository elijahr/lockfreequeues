## Migrated from `t_mupsic_threaded.nim` — high-contention concurrent
## test for the unified Queue under MPSC cardinality.
##
## Mechanical conversion per Doc C 5:
##   ptr Mupsic[N, ProducerCount, int] -> ptr Queue[int, ccMulti, ccSingle,
##                                                    stEager, rkNone, N,
##                                                    ProducerCount, 0, 0, 0]
##   initMupsic[N, ProducerCount, int]() -> initQueue[int, ccMulti, ccSingle,
##                                                     stEager, N,
##                                                     ProducerCount, 0]()
##
## Test count parity: 2 tests (matches t_mupsic_threaded.nim).
