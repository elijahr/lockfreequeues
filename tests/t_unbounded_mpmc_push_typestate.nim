...
suite "MPMC Push Typestate":
  ...
  test "typestate types exist and are usable":
    ...
    discard claimResult.mpmcpushslotclaimed.writeItem(0)
      .markCommitted()
      .extractPinned()
      .unpin()
    freeTestSegment(seg)
  ...
  test "loadSegment loads tail segment":
    ...
    let complete = claimResult.mpmcpushslotclaimed.writeItem(42)
      .markCommitted()
  ...
  test "tryClaimSlot returns SlotClaimed when CAS succeeds":
    ...
    discard claimResult.mpmcpushslotclaimed.writeItem(42)
      .markCommitted()
      .extractPinned()
      .unpin()
  ...
  test "tryClaimSlot returns Ready when CAS fails (retry path)":
    ...
    let claimResult2 = claimResult.mpmcpushready
      .loadSegment()
      .tryClaimSlot()
    check claimResult2.kind == mMPMCPushSlotClaimed
    discard claimResult2.mpmcpushslotclaimed
  ...
  test "allocateNewSegment handles allocation race":
    ...
    let (ready, allocated) = claimResult.mpmcpushsegmentfull
  ...
  test "markCommitted sets committed flag and updates itemCount":
    ...
    let complete = claimResult.mpmcpushslotclaimed
      .writeItem(42)
      .markCommitted()
